<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <hr class="my-3">
            <!-- Heading -->
            <h6 class="navbar-heading text-muted">About Vroom</h6>
            <!-- Navigation -->
            <ul class="navbar-nav mb-md-3">
                <li class="nav-item">
                    <a class="nav-link" href="https://github.com/MrShameer/Vroom" target="_blank">
                        <i class="ni ni-spaceship"></i> Vroom App
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://github.com/MrShameer/vroom-api" target="_blank">
                        <i class="ni ni-palette"></i> API
                    </a>
                </li>
            </ul>
        </div>
